...
const Scene3WhatIf: React.FC = () => {
  ...
  // Final phrase shares the header entrance — always visible from scene start
    ...
    <SceneWrapper topColor="#7dd3fc" bottomColor="#5bc2f5">
      <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", padding: 120 }}>
        <div style={{ textAlign: "center" }}>
          ...
          {/* "workspace that agents call home" — always in layout, opacity drives timing */}
          <div
            style={{
              fontFamily,
              fontSize: 84,
          ...
          >
            workspace that agents call home
          </div>
...
export const INTRO_DURATION = S1 + S2 + S3 + S_TERM + S4 + S56 + S7 - T * 3 - T_QUICK * 2;
